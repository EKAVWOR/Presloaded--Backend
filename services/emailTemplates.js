...
<div style="${baseStyles}">
  ...
  <div style="background: #ffffff; padding: 32px; border: 1px solid #e5e7eb; border-top: none;">
    ...
    <p style="color: #4b5563; line-height: 1.7;">
      Thanks for creating an account with ${academyName}! Please verify your
...
<div style="${baseStyles}">
  ...
  <div style="background: #ffffff; padding: 32px; border: 1px solid #e5e7eb; border-top: none;">
    ...
    <p style="color: #4b5563; line-height: 1.7;">
      Your email has been verified. You're all set to explore our courses
      and start your tech journey!
    </p>
    ...
    <div style="text-align: center; margin: 32px 0;">
      <a href="${process.env.CLIENT_URL}/courses" style="${buttonStyle}">
        Browse Courses
      </a>
    </div>
  </div>
...
<div style="${baseStyles}">
  ...
  <div style="background: #ffffff; padding: 32px; border: 1px solid #e5e7eb; border-top: none;">
    ...
    <p style="color: #4b5563; line-height: 1.7;">
      Your payment has been received and your enrolment is confirmed!
      Here's a summary:
    </p>
    ...
    <p style="color: #4b5563; line-height: 1.7;">
      Your admission letter will be sent shortly as a separate email
  ...
  <div style="background: #ffffff; padding: 32px; border: 1px solid #e5e7eb; border-top: none;">
    ...
    <div style="background: #f0fdf4; border: 1px solid #bbf7d0; border-radius: 8px; padding: 16px; margin: 20px 0;">
      <p style="color: #166534; margin: 0;">
        ...
        Admission_Letter_${name.replace(/\s+/g, "_")}.pdf
      </p>
    </div>
    <p style="color: #4b5563; line-height: 1.7;">
...
<div style="${baseStyles}">
  ...
  <div style="background: #ffffff; padding: 32px; border: 1px solid #e5e7eb; border-top: none;">
    ...
    <p style="color: #4b5563; line-height: 1.7;">
      We are proud to inform you that you have successfully completed the
      course and your certificate has been issued. Please find your
    ...
    <p style="color: #4b5563; line-height: 1.7;">
      You can verify your certificate online using the certificate number
      above. Share your achievement with the world!
    </p>
    <div style="text-align: center; margin: 32px 0;">
      <a
